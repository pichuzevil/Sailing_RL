...
def parse_args():
    ...
    parser.add_argument("--epsilon_decay", type=float, default=0.999, help="Slow decay for Scenario 1")
    ...
    for ep in range(args.episodes):
        ...
        for step in range(500): #
            ...
            if random.random() < epsilon:
                ...
                # Normalization is now handled by the Buffer, 
                # but we still normalize here for the 'act' inference
            ...
            # Smart Reward utility (including wind efficiency and crash penalties)
        ...
        if ep % 50 == 0:
            print(f"Ep {ep:4d} | Success Rate (100ep): {current_success_rate:.2f} | Eps: {epsilon:.3f}")

    print(f"Training finished. Best Success Rate achieved: {best_success_rate:.2f}")
